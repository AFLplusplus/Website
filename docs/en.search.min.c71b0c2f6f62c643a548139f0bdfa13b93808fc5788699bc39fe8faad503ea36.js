...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fa310ae041e4ed3a8ed18ebc4aefeb540ef7612eab132f0078c3deca25d62aea.js',function(){input.required=false;search();});}
