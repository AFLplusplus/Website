...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.28cc58043d999cbd8d39a79a6d1cbda4ea2e4ace9c9e32a80d188106bb50bc94.js',function(){input.required=false;search();});}
