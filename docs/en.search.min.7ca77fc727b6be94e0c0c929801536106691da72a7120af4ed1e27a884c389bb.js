...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f665a418aac8fdcb4a59d345e983622ef0e19a88c0bdd497150cb68c804549f8.js',function(){input.required=false;search();});}
