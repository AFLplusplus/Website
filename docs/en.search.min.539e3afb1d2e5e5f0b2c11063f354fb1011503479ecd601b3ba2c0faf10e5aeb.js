...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5312462e5da8aae357c81c40fda75576af6a8ab2e99ed6589b91a81db329e3bd.js',function(){input.required=false;search();});}
