...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d7e0ae2d66f1a85a077fbb51546c2a097a4b374c7aeab13a306a81133a0966fd.js',function(){input.required=false;search();});}
