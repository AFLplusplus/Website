...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3ac5dcdc62f535258f305654333f446df1eb82ef5db5646e40cc3ce239d9c005.js',function(){input.required=false;search();});}
