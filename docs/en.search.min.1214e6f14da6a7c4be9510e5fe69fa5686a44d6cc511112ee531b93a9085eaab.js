...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.85011510471658524c4fee41ea62027d172576d8f74cd2182b7aee0f956ab4d2.js',function(){input.required=false;search();});}
