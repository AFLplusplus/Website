...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cd012efc8a646d154b7c1faaa11a9155090d2274c2a81576c1e4e0cd38a92b24.js',function(){input.required=false;search();});}
