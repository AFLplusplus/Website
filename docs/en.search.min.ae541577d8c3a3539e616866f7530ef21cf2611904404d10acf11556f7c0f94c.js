...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.aec07dedb53b1b5d737d2b75fdaa94a6092b7fe126ec74f7e10ebdbc9b801657.js',function(){input.required=false;search();});}
