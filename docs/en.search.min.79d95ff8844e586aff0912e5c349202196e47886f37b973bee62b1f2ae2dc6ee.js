...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dd09a81a701467f79d12ab6c40e9b80bedf7a3e6d1516f42bd9d970ca1d36b35.js',function(){input.required=false;search();});}
