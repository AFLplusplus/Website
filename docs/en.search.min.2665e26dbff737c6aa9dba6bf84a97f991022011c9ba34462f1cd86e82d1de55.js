...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.88e785e5fb5811a888655cb4b70dfc1bc8eec5bd97511a2e001a272033cec3b2.js',function(){input.required=false;search();});}
