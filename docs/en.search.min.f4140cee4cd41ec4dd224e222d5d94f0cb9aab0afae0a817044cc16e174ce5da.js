...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2cbc04d039d5b25caaac620f5b3750e6547cf1aef8a73e863dc0adaf9eb035d1.js',function(){input.required=false;search();});}
