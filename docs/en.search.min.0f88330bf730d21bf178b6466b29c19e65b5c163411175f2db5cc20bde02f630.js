...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.84e6d9381d82ff1d1dd8ee747be27ecce8d74b698d406b6b0ac0d2df7f85ec73.js',function(){input.required=false;search();});}
