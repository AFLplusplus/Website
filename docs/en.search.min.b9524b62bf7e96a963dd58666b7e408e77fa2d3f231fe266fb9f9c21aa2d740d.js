...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ec71f8072dc2c4695eeabf9b622712d59fdb15a528556de275a5f000ccc63547.js',function(){input.required=false;search();});}
