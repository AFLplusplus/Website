...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2de3c0376c58af13f5b6651e98aeaf7dc024a00737f2aeb5a978f39fc4a2f2a2.js',function(){input.required=false;search();});}
