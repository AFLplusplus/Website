...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.69ff4e6928d8aefd03d2a68a7e14053087b22141d7a7ff5b549308cb9a533fd1.js',function(){input.required=false;search();});}
