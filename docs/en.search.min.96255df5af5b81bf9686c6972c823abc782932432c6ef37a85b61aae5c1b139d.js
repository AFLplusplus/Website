...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.496996f159eb5e8283ad5da1eda63ee39fc20a4eb0a88675d376e2cde493ac86.js',function(){input.required=false;search();});}
