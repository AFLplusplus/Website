...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.37203ae88a1c9e94c94da00570725bd8bbeb4399ea23355571126d8d5375ab03.js',function(){input.required=false;search();});}
