...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2e9fc4a4e1ab18d76bb9526f40ecbdd7dd651fd4bfc0e00fbcfb55d3c818d076.js',function(){input.required=false;search();});}
